...
**Versi: 1.1.0** (15 September 2026) — live di [dashboard.selaras-ajar.id](https://dashboard.selaras-ajar.id). Riwayat perubahan lengkap ada di [CHANGELOG.md](./CHANGELOG.md). Dokumentasi API (eksternal `/api/v1` via API key + referensi lengkap seluruh endpoint internal) ada di [docs/API.md](./docs/API.md). Versi README sebelumnya diarsipkan di [docs/readme-history/](./docs/readme-history/INDEX.md).
