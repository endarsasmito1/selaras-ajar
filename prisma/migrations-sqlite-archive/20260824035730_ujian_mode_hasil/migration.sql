...
CREATE TABLE "new_Ujian" (
    ...
    "modeHasil" TEXT NOT NULL DEFAULT 'SETELAH_JADWAL_BERAKHIR',
...
INSERT INTO "new_Ujian" ("acakJawaban", "acakSoal", "babId", "createdAt", "dibuatOlehId", "durasiMenit", "id", "jenis", "jenisPenilaian", "judul", "mapelId", "rppId", "sekaliAkses", "status") SELECT "acakJawaban", "acakSoal", "babId", "createdAt", "dibuatOlehId", "durasiMenit", "id", "jenis", "jenisPenilaian", "judul", "mapelId", "rppId", "sekaliAkses", "status" FROM "Ujian";
DROP TABLE "Ujian";
